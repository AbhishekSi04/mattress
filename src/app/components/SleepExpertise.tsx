      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2 relative">
            ...
            <div className="absolute -bottom-6 -right-6 bg-indigo-100 rounded-full p-4 shadow-lg">
              <div className="text-indigo-800 font-bold text-xl">2+ Years</div>
              <div className="text-indigo-600 text-sm">of Research</div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 border-l-4 border-indigo-600">
                  <div className="flex items-center mb-4">
                    <Star className="text-indigo-600 h-6 w-6 mr-3" />
                ...
                <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 border-l-4 border-indigo-600">
                  <div className="flex items-center mb-4">
                    <Activity className="text-indigo-600 h-6 w-6 mr-3" />
                ...
                <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 border-l-4 border-indigo-600">
                  <div className="flex items-center mb-4">
                    <Moon className="text-indigo-600 h-6 w-6 mr-3" />
                ...
                <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 border-l-4 border-indigo-600">
                  <div className="flex items-center mb-4">
                    <Shield className="text-indigo-600 h-6 w-6 mr-3" />
