...
const ProductShowcase = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      images: ['/orthopaedic.png', '/orthopaedic.png'],
      price: '₹39,999',
      salePrice: '₹32,999',
      rating: 4.8,
      reviewCount: 154,
    ...
    <section className="py-16 bg-gradient-to-b from-white to-indigo-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4 text-[#1aa39a]">Science Behind Sleep</h2>
